...
KMETA ?= "kernel-meta"
KSRC_linux_windriver_4_1 ?= "${THISDIR}/../../git/kernel-4.1.x.git"
KSRC_kernel_cache ?= "${THISDIR}/../../git/kernel-cache.git"
EXTRA_KERNEL_SRC_URI ?= ""
SRC_URI = "git://${KSRC_linux_windriver_4_1};protocol=file;branch=${KBRANCH};name=machine \
	   git://${KSRC_kernel_cache};protocol=file;type=kmeta;name=meta;branch=WRLINUX_8_0_HEAD;destsuffix=${KMETA} \
	   ${EXTRA_KERNEL_SRC_URI} \
"
