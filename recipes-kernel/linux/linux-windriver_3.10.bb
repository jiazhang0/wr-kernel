...
KSRC_linux_windriver_3_10 ?= "${THISDIR}/../../git/kernel-3.10.x.git"
SRC_URI = "git://${KSRC_linux_windriver_3_10};protocol=file;nocheckout=1;branch=${KBRANCH},meta;name=machine,meta${EXTRA_KERNEL_SRC_URI}"
